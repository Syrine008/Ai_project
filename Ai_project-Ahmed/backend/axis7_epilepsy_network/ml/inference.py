"""Inference for axis7-epilepsy-network.

Plug your trained model in by saving it to:

    axis7_epilepsy_network_model.pkl
...
MODEL_PATH = Path(__file__).resolve().parent / "axis7_epilepsy_network_model.pkl"
...
def preprocess(upload, metadata: dict) -> Any:
    ...
    TODO: implement real preprocessing for EEG / Signal input.
