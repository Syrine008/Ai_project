...
Plug your trained model in by saving it to:
    ...
    axis5_functional_connectivity_model.pkl
...
MODEL_PATH = Path(__file__).resolve().parent / "axis5_functional_connectivity_model.pkl"
...
def preprocess(upload, metadata: dict) -> Any:
    ...
    TODO: implement real preprocessing for fMRI input.
